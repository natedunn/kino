/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=gateway/wrangler.preview.jsonc gateway/worker-configuration.d.ts` (hash: 0241ecb1e8bf3e6dcff8079dc4d87e3c)
// Runtime types generated with workerd@1.20260730.1 2026-05-22
interface __BaseEnv_Env {
	OAUTH_STATES: DurableObjectNamespace<import('./cloud-entry').OAuthState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./cloud-entry');
		durableNamespaces: 'OAuthState';
	}
