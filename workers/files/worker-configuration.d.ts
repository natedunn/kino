/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env=preview --strict-vars=false` (hash: b4cb900428823104261de2f939daead5)
// Runtime types generated with workerd@1.20260730.1 2026-08-14 nodejs_compat
interface __BaseEnv_Env {
	ORG_UPLOADS: R2Bucket;
	NATIVE_CONVEX_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NATIVE_CONVEX_URL">> {}
}
