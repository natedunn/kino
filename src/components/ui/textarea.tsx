...
const textareaVariants = cva(
  "flex field-sizing-content w-full rounded-lg border border-input bg-absolute text-base transition-colors outline-none placeholder:text-muted-foreground/50 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring-accent/20 dark:focus-visible:ring-ring-accent/40 disabled:cursor-not-allowed disabled:bg-input/50 disabled:opacity-50 read-only:cursor-default read-only:bg-input-readonly-background read-only:text-muted-foreground read-only:focus-visible:border-input read-only:focus-visible:ring-0 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 md:text-sm dark:bg-input-background dark:read-only:bg-input-readonly-background dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40",
  {
    variants: {
      size: {
