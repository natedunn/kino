...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-1 rounded-md text-sm font-medium whitespace-nowrap transition-colors outline-none select-none disabled:pointer-events-none disabled:opacity-50 disabled:grayscale aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5",
  {
    variants: {
      variant: {
        default:
          "border border-blue-500 bg-gradient-to-tl from-primary to-blue-400 text-background dark:border-blue-300 dark:text-foreground hocus:border-blue-800 hocus:to-blue-600 hocus:dark:border-blue-400 [&:active]:border-blue-700 [&:active]:from-primary [&:active]:to-blue-500 dark:[&:active]:border-blue-500 dark:[&:active]:from-blue-600 dark:[&:active]:to-blue-700 [&:is(:hover,:focus-visible):active]:border-blue-700 [&:is(:hover,:focus-visible):active]:to-blue-500 dark:[&:is(:hover,:focus-visible):active]:border-blue-500 dark:[&:is(:hover,:focus-visible):active]:from-blue-600 dark:[&:is(:hover,:focus-visible):active]:to-blue-700",
        destructive: [
          ...
          "[&:active]:border-red-950 [&:active]:from-red-600 [&:active]:via-red-800 [&:active]:to-red-900 [&:active]:text-red-50",
          "dark:border-red-400 dark:from-red-500 dark:via-red-700 dark:to-red-700",
          "hocus:dark:border-red-500 hocus:dark:from-red-600 hocus:dark:via-red-800 hocus:dark:to-red-800 hocus:dark:text-red-50 dark:[&:active]:border-red-600 dark:[&:active]:from-red-700 dark:[&:active]:via-red-900 dark:[&:active]:to-red-950 [&:is(:hover,:focus-visible):active]:border-red-950 [&:is(:hover,:focus-visible):active]:from-red-600 [&:is(:hover,:focus-visible):active]:via-red-800 [&:is(:hover,:focus-visible):active]:to-red-900 dark:[&:is(:hover,:focus-visible):active]:border-red-600 dark:[&:is(:hover,:focus-visible):active]:from-red-700 dark:[&:is(:hover,:focus-visible):active]:via-red-900 dark:[&:is(:hover,:focus-visible):active]:to-red-950",
        ],
        outline: [
          "border border-foreground/30 bg-background text-foreground",
          "hocus:border-foreground/45 hocus:bg-muted",
          "[&:active]:border-foreground/55 [&:active]:bg-accent",
          "dark:border-foreground/20 dark:bg-background",
          "hocus:dark:border-foreground/35 hocus:dark:bg-secondary",
          "dark:[&:active]:border-foreground/45 dark:[&:active]:bg-accent [&:is(:hover,:focus-visible):active]:border-foreground/55 [&:is(:hover,:focus-visible):active]:bg-accent dark:[&:is(:hover,:focus-visible):active]:border-foreground/45 dark:[&:is(:hover,:focus-visible):active]:bg-accent",
        ],
        secondary: [
          "border border-foreground/10 bg-gradient-to-tl from-muted via-accent to-background text-secondary-foreground",
          ...
          "hocus:border-foreground/25 hocus:from-accent hocus:via-accent hocus:to-muted hocus:text-accent-foreground",
          "[&:active]:border-foreground/35 [&:active]:from-accent [&:active]:via-accent [&:active]:to-muted [&:active]:text-accent-foreground",
          "dark:border-foreground/10 dark:from-secondary dark:via-accent dark:to-background",
          ...
          "hocus:dark:border-foreground/25 hocus:dark:from-accent hocus:dark:via-accent hocus:dark:to-secondary",
