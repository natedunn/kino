				...
				<CardContent className='flex gap-4'>
					<button
						...
						className={
							...
							(voted ? 'border-primary bg-primary/5 text-primary' : 'hover:bg-muted/60')
						}
					>
					...
					<div className='min-w-0 flex-1 space-y-2'>
						<div className='flex items-start justify-between gap-2'>
							<div className='space-y-1'>
								<p className='leading-tight font-medium'>Dark mode for the dashboard</p>
								<p className='text-sm text-muted-foreground'>
									It would be great to have a system-aware dark theme across the whole app,
									especially the analytics views.
								</p>
							</div>
							<DropdownMenu>
		...
		<ExampleStage>
			<Card className='w-full max-w-lg'>
				<CardHeader>
					...
					<CardDescription>Manage how your project appears to others.</CardDescription>
				</CardHeader>
				<CardContent className='space-y-5'>
					...
					<div>
						<LabelWrapper>
							...
							<LabelDescription>Shown on the public project page.</LabelDescription>
						</LabelWrapper>
						<Textarea
							id='ex-desc'
		...
		<ExampleStage>
			<div className='flex w-full max-w-md gap-3'>
				<Avatar className='size-9 border'>
					<AvatarImage src='https://avatars.githubusercontent.com/u/124599?v=4' alt='@you' />
...
export const EXAMPLE_ITEMS: Array<LabItem> = [
	{
		id: 'sign-in',
		name: 'Sign in',
		description: 'Card, inputs, checkbox and buttons combined into an auth form.',
