	...
	return (
		<Demo title='Image, fallback & sizes'>
			<Avatar className='size-12'>
				<AvatarImage src='https://avatars.githubusercontent.com/u/124599?v=4' alt='@torvalds' />
		...
		<Demo title='Anatomy' center>
			<Card className='w-full max-w-sm'>
				...
				<CardContent className='text-sm text-muted-foreground'>
					Unlock unlimited projects, advanced analytics and priority support when you upgrade to
					Pro.
				</CardContent>
...
function InputGroupDemo() {
	return (
		<>
			...
			<Demo title='Trailing action' className='flex-col items-stretch sm:max-w-sm'>
				<InputGroup>
		...
		<Demo title='Field label' className='flex-col items-stretch sm:max-w-sm'>
			<div>
				<LabelWrapper>
					...
					<LabelDescription>We&apos;ll never share it with anyone.</LabelDescription>
				</LabelWrapper>
...
function SelectDemo() {
	...
	return (
		<Demo title='Single select' center>
			<Select items={FRUITS} value={value} onValueChange={(v) => setValue(v as string)}>
			...
			<Dialog>
				...
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							This permanently removes the project and all of its feedback, updates and discussions.
							This action cannot be undone.
						</DialogDescription>
					</DialogHeader>
					<DialogFooter>
						<DialogClose render={<Button variant='outline' />}>Cancel</DialogClose>
						<DialogClose render={<Button variant='destructive' />}>Delete project</DialogClose>
					</DialogFooter>
				</DialogContent>
			</Dialog>
		</Demo>
					...
					<div className='space-y-3'>
						...
						<div className='grid gap-2'>
							<div className='grid grid-cols-3 items-center gap-2'>
								...
								<Input id='lab-width' size='sm' defaultValue='100%' className='col-span-2' />
							</div>
							<div className='grid grid-cols-3 items-center gap-2'>
								<Label htmlFor='lab-height'>Height</Label>
								<Input id='lab-height' size='sm' defaultValue='25px' className='col-span-2' />
							</div>
						</div>
					</div>
				</PopoverContent>
	...
	return (
		<Demo title='Collapsible' className='flex-col items-stretch sm:max-w-sm'>
			<Collapsible open={open} onOpenChange={setOpen} className='w-full space-y-2'>
				...
				<div className='rounded-md border px-3 py-2 font-mono text-sm'>@kino/relay</div>
				<CollapsibleContent className='space-y-2'>
					<div className='rounded-md border px-3 py-2 font-mono text-sm'>@kino/gateway</div>
					<div className='rounded-md border px-3 py-2 font-mono text-sm'>@kino/blinking</div>
				</CollapsibleContent>
			</Collapsible>
		</Demo>
	);
...
function CopySnippetDemo() {
	return (
		<>
			<Demo title='Single line' description='Click to copy the snippet to the clipboard.'>
				<CopySnippet code={`import { Button } from "@/components/ui/button"`} className='w-full' />
			</Demo>
