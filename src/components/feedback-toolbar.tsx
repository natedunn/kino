        ...
        <div className="flex items-center gap-2">
          <Button variant={showFilters ? "default" : "outline"} size="sm" onClick={() => setShowFilters(!showFilters)}>
            ...
            {hasActiveFilters && (
              ...
              >
                {[statusFilter !== "all", tagFilter !== "all", dateAfter, dateBefore].filter(Boolean).length}
              </Badge>
            )}
          </Button>
            ...
            <div className="space-y-2">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    className={cn("w-full justify-start text-left font-normal", !dateAfter && "text-muted-foreground")}
                  >
            ...
            <div className="space-y-2">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    className={cn("w-full justify-start text-left font-normal", !dateBefore && "text-muted-foreground")}
                  >
                    <CalendarIcon className="mr-2 h-4 w-4" />
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar mode="single" selected={dateBefore} onSelect={setDateBefore} initialFocus />
                </PopoverContent>
              </Popover>
            </div>
          </div>
