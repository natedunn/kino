...
export function trackAuthStarted(operation: AuthOperation, properties?: Record<string, unknown>) {
	capturePostHogEvent(`auth_${operation}_started`, properties);
}

export function trackAuthSuccess(operation: AuthOperation, properties?: Record<string, unknown>) {
