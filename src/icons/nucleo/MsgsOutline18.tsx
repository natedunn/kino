...
export type MsgsOutline18Props = SVGProps<SVGSVGElement> & {
	strokeWidth?: number | string;
};

export function MsgsOutline18({ strokeWidth = 1.5, ...props }: MsgsOutline18Props) {
	return (
