...
function RouteComponent() {
	const { data } = useSuspenseQuery(convexQuery(api.org.findMyOrgs, {}));

	return (
		<div className='relative w-full'>
			<div className='absolute top-0 right-0 left-0 z-0 h-64 w-full bg-linear-to-t from-background to-muted'></div>
