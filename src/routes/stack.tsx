...
const SECTIONS: TechSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        name: "Convex",
        blurb:
          "Reactive backend and database for our data and server functions.",
  ...
  },
  {
    title: "UI",
    description:
      "The components, primitives, and styling behind the interface.",
    items: [
      {
        name: "shadcn/ui",
        ...
        <section className="container py-16 md:py-24">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 max-w-xl text-lg leading-relaxed text-muted-foreground">
              The tools and technologies we use to build and run Kino — and what
              each one does in the project.
            </p>
          </div>
        </section>
...
function TechRow({ item }: { item: TechItem }) {
  ...
  const className =
    "group flex items-center gap-4 bg-card p-5 transition-colors md:p-6"
