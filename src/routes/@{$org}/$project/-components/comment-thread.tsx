...
const CommentEditorContext =
  createContext<RefObject<MarkdownEditorRef | null> | null>(null)
...
export function CommentEditorProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <CommentEditorContext.Provider value={editorRef}>
      {children}
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {emoteEntries.map(([emoteType, data]) => (
                  <EmoteButton
                    ...
                    isActive={
                      currentProfileId
                        ? data.authorProfileIds.includes(currentProfileId)
                        : false
                    }
                    key={emoteType}
    ...
    <div className="relative">
      <div
        ...
        style={
          isExpanded
            ? undefined
            : { maxHeight: isOverflowing ? COLLAPSED_MAX_HEIGHT : undefined }
        }
      >
        {children}
      </div>
