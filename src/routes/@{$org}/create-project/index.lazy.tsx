...
export const Route = createLazyFileRoute("/@{$org}/create-project/")({
              ...
              {(values) => (
                <div className="relative flex flex-col pr-6">
                  ...
                  <div className="z-10 flex w-full flex-col items-center justify-center pt-10">
                    ...
                    <div
                      className={cn(
                        "mt-3 w-full text-center text-2xl font-bold",
                        {
                  ...
                  {(field) => (
                    <div className="flex items-end gap-3">
                      <div className="flex flex-1 flex-col gap-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Will be used in URL of your project. Must be unique to
                          your organization.
                        </p>
