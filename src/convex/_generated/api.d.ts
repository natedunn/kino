...
import type * as utils_queries_getProjectUserData from '../utils/queries/getProjectUserDetails.js';
				...
				'internal',
				{
					input:
						...
						| {
								...
								where?: Array<{
									connector?: 'AND' | 'OR';
									field: 'name' | 'slug' | 'logo' | 'createdAt' | 'metadata' | 'id';
									operator?:
										| 'lt'
										| 'lte'
										| 'gt'
						...
						| {
								...
								where?: Array<{
									connector?: 'AND' | 'OR';
									field: 'organizationId' | 'userId' | 'role' | 'createdAt' | 'id';
									operator?:
										| 'lt'
										| 'lte'
										| 'gt'
