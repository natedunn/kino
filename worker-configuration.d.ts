/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d0cdb43551d30ad0f1a3105fa0ca49b6)
...
declare namespace Cloudflare {
	interface Env {
		...
		R2_TOKEN: string;
		R2_USER_UPLOADS_ACCESS_KEY_ID: string;
		R2_USER_UPLOADS_SECRET_ACCESS_KEY: string;
		R2_USER_UPLOADS_BUCKET: string;
		R2_USER_UPLOADS_ENDPOINT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONVEX_DEPLOYMENT" | "VITE_CONVEX_URL" | "VITE_CONVEX_SITE_URL" | "BETTER_AUTH_SECRET" | "SITE_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "R2_TOKEN" | "R2_USER_UPLOADS_ACCESS_KEY_ID" | "R2_USER_UPLOADS_SECRET_ACCESS_KEY" | "R2_USER_UPLOADS_BUCKET" | "R2_USER_UPLOADS_ENDPOINT" | "VITE_LOG_LEVEL">> {}
}
