...
export const api = {
  ...
  feedback: {
    ...
    updatePriority: createApiLeaf<"mutation", typeof import("../functions/feedback").updatePriority>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/feedback").updatePriority>("feedback:updatePriority"), { auth: "required", type: "mutation" }),
  ...
  file: {
    completeUpload: createApiLeaf<"mutation", typeof import("../functions/file").completeUpload>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/file").completeUpload>("file:completeUpload"), { auth: "required", type: "mutation" }),
    createDirectUploadBatch: createApiLeaf<"mutation", typeof import("../functions/file").createDirectUploadBatch>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/file").createDirectUploadBatch>("file:createDirectUploadBatch"), { auth: "required", type: "mutation" }),
    createFolder: createApiLeaf<"mutation", typeof import("../functions/file").createFolder>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/file").createFolder>("file:createFolder"), { auth: "required", type: "mutation" }),
    ensureThumbnails: createApiLeaf<"mutation", typeof import("../functions/file").ensureThumbnails>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/file").ensureThumbnails>("file:ensureThumbnails"), { auth: "required", type: "mutation" }),
    getDownloadUrl: createApiLeaf<"query", typeof import("../functions/file").getDownloadUrl>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/file").getDownloadUrl>("file:getDownloadUrl"), { auth: "optional", type: "query" }),
    getFileDetail: createApiLeaf<"query", typeof import("../functions/file").getFileDetail>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/file").getFileDetail>("file:getFileDetail"), { auth: "optional", type: "query" }),
    getOrgUsage: createApiLeaf<"query", typeof import("../functions/file").getOrgUsage>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/file").getOrgUsage>("file:getOrgUsage"), { auth: "required", type: "query" }),
    getPolicy: createApiLeaf<"query", typeof import("../functions/file").getPolicy>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/file").getPolicy>("file:getPolicy"), { auth: "optional", type: "query" }),
    getProjectUsage: createApiLeaf<"query", typeof import("../functions/file").getProjectUsage>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/file").getProjectUsage>("file:getProjectUsage"), { auth: "required", type: "query" }),
    getUploadStatus: createApiLeaf<"query", typeof import("../functions/file").getUploadStatus>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/file").getUploadStatus>("file:getUploadStatus"), { auth: "required", type: "query" }),
    listFileTreeItems: createApiLeaf<"query", typeof import("../functions/file").listFileTreeItems>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/file").listFileTreeItems>("file:listFileTreeItems"), { auth: "optional", type: "query" }),
    listFolders: createApiLeaf<"query", typeof import("../functions/file").listFolders>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/file").listFolders>("file:listFolders"), { auth: "optional", type: "query" }),
    listProjectFiles: createApiLeaf<"query", typeof import("../functions/file").listProjectFiles>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/file").listProjectFiles>("file:listProjectFiles"), { auth: "optional", limit: 50, type: "query" }),
    moveAsset: createApiLeaf<"mutation", typeof import("../functions/file").moveAsset>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/file").moveAsset>("file:moveAsset"), { auth: "required", type: "mutation" }),
    moveFolder: createApiLeaf<"mutation", typeof import("../functions/file").moveFolder>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/file").moveFolder>("file:moveFolder"), { auth: "required", type: "mutation" }),
    removeAsset: createApiLeaf<"mutation", typeof import("../functions/file").removeAsset>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/file").removeAsset>("file:removeAsset"), { auth: "required", type: "mutation" }),
    removeFolder: createApiLeaf<"mutation", typeof import("../functions/file").removeFolder>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/file").removeFolder>("file:removeFolder"), { auth: "required", type: "mutation" }),
    renameAsset: createApiLeaf<"mutation", typeof import("../functions/file").renameAsset>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/file").renameAsset>("file:renameAsset"), { auth: "required", type: "mutation" }),
    renameFolder: createApiLeaf<"mutation", typeof import("../functions/file").renameFolder>(createGeneratedFunctionReference<"mutation", "public", typeof import("../functions/file").renameFolder>("file:renameFolder"), { auth: "required", type: "mutation" }),
  },
  github: {
  ...
  update: {
    ...
    listFeatured: createApiLeaf<"query", typeof import("../functions/update").listFeatured>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/update").listFeatured>("update:listFeatured"), { auth: "optional", type: "query" }),
    ...
    searchProject: createApiLeaf<"query", typeof import("../functions/update").searchProject>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/update").searchProject>("update:searchProject"), { auth: "optional", limit: 10, type: "query" }),
