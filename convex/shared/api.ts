...
export const api = {
  feedback: {
    ...
    listProjectFeedback: createApiLeaf<"query", typeof import("../functions/feedback").listProjectFeedback>(createGeneratedFunctionReference<"query", "public", typeof import("../functions/feedback").listProjectFeedback>("feedback:listProjectFeedback"), { auth: "optional", type: "query" }),
