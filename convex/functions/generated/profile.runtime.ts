	...
	findMyProfile: [
		...
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'query',
				'public',
				typeof import('../profile').findMyProfile
			>('profile:findMyProfile'),
			() => (require('../profile') as Record<string, unknown>)['findMyProfile']
		),
	],
	generateAvatarUploadUrl: [
		...
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'mutation',
				'public',
				typeof import('../profile').generateAvatarUploadUrl
			>('profile:generateAvatarUploadUrl'),
			() => (require('../profile') as Record<string, unknown>)['generateAvatarUploadUrl']
		),
	],
	getByUsername: [
		'query',
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'query',
				'public',
				typeof import('../profile').getByUsername
			>('profile:getByUsername'),
			() => (require('../profile') as Record<string, unknown>)['getByUsername']
		),
	],
	syncMetadata: [
		'mutation',
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'mutation',
				'public',
				typeof import('../profile').syncMetadata
			>('profile:syncMetadata'),
			() => (require('../profile') as Record<string, unknown>)['syncMetadata']
		),
	],
	update: [
		'mutation',
		typedProcedureResolver(
			createGeneratedFunctionReference<'mutation', 'public', typeof import('../profile').update>(
				'profile:update'
			),
			() => (require('../profile') as Record<string, unknown>)['update']
		),
	],
} as const;
