	...
	toggle: [
		...
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'mutation',
				'public',
				typeof import('../updateEmote').toggle
			>('updateEmote:toggle'),
			() => (require('../updateEmote') as Record<string, unknown>)['toggle']
		),
	],
} as const;
...
export function createUpdateEmoteCaller<TCtx extends ProcedureCallerContext>(
	ctx: TCtx
): GeneratedProcedureCaller<TCtx> {
	return generatedRuntime.getCallerFactory()(ctx as any) as GeneratedProcedureCaller<TCtx>;
}

export function createUpdateEmoteHandler<TCtx extends ProcedureHandlerContext>(
	ctx: TCtx
