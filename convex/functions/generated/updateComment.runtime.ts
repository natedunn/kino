...
const procedureRegistry = {
  "create": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../updateComment").create>("updateComment:create"), () => (require("../updateComment") as Record<string, unknown>)["create"])],
  "listByUpdate": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../updateComment").listByUpdate>("updateComment:listByUpdate"), () => (require("../updateComment") as Record<string, unknown>)["listByUpdate"])],
  "remove": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../updateComment").remove>("updateComment:remove"), () => (require("../updateComment") as Record<string, unknown>)["remove"])],
  "update": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../updateComment").update>("updateComment:update"), () => (require("../updateComment") as Record<string, unknown>)["update"])],
} as const;
