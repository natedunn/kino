	...
	create: [
		...
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'mutation',
				'internal',
				typeof import('../feedbackEvent').create
			>('feedbackEvent:create'),
			() => (require('../feedbackEvent') as Record<string, unknown>)['create']
		),
	],
	listByFeedback: [
		'query',
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'query',
				'public',
				typeof import('../feedbackEvent').listByFeedback
			>('feedbackEvent:listByFeedback'),
			() => (require('../feedbackEvent') as Record<string, unknown>)['listByFeedback']
		),
	],
} as const;
...
export function createFeedbackEventCaller<TCtx extends ProcedureCallerContext>(
	ctx: TCtx
): GeneratedProcedureCaller<TCtx> {
	return generatedRuntime.getCallerFactory()(ctx as any) as GeneratedProcedureCaller<TCtx>;
}

export function createFeedbackEventHandler<TCtx extends ProcedureHandlerContext>(
	ctx: TCtx
