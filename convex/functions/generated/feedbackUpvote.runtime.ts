...
const procedureRegistry = {
  "getCount": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../feedbackUpvote").getCount>("feedbackUpvote:getCount"), () => (require("../feedbackUpvote") as Record<string, unknown>)["getCount"])],
  "getUpvoteData": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../feedbackUpvote").getUpvoteData>("feedbackUpvote:getUpvoteData"), () => (require("../feedbackUpvote") as Record<string, unknown>)["getUpvoteData"])],
  "hasUpvoted": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../feedbackUpvote").hasUpvoted>("feedbackUpvote:hasUpvoted"), () => (require("../feedbackUpvote") as Record<string, unknown>)["hasUpvoted"])],
  "toggle": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../feedbackUpvote").toggle>("feedbackUpvote:toggle"), () => (require("../feedbackUpvote") as Record<string, unknown>)["toggle"])],
} as const;
...
export function createFeedbackUpvoteCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createFeedbackUpvoteHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
