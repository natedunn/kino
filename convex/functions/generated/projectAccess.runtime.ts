...
const procedureRegistry = {
  "getManagementState": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../projectAccess").getManagementState>("projectAccess:getManagementState"), () => (require("../projectAccess") as Record<string, unknown>)["getManagementState"])],
  "setModeratorAccess": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../projectAccess").setModeratorAccess>("projectAccess:setModeratorAccess"), () => (require("../projectAccess") as Record<string, unknown>)["setModeratorAccess"])],
} as const;
...
export function createProjectAccessCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createProjectAccessHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
