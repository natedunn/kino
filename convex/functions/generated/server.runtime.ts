...
import type { GeneratedRegistryCallerForContext } from 'kitcn/server';
...
const procedureRegistry = {
	...
	aggregateBackfillChunk: [
		...
		typedProcedureResolver(
			...
			() => (require('./server') as Record<string, unknown>)['aggregateBackfillChunk']
		),
	],
	aggregateBackfillStatus: [
		...
		typedProcedureResolver(
			...
			() => (require('./server') as Record<string, unknown>)['aggregateBackfillStatus']
		),
	],
	migrationCancel: [
		'mutation',
	...
	scheduledMutationBatch: [
		...
		typedProcedureResolver(
			...
			() => (require('./server') as Record<string, unknown>)['scheduledMutationBatch']
		),
	],
} as const;
