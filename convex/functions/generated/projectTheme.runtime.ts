...
const procedureRegistry = {
  "getEditorState": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../projectTheme").getEditorState>("projectTheme:getEditorState"), () => (require("../projectTheme") as Record<string, unknown>)["getEditorState"])],
  "publish": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../projectTheme").publish>("projectTheme:publish"), () => (require("../projectTheme") as Record<string, unknown>)["publish"])],
} as const;
...
export function createProjectThemeCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createProjectThemeHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
