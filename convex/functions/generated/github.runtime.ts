...
const procedureRegistry = {
  ...
  "disconnectRepository": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../github").disconnectRepository>("github:disconnectRepository"), () => (require("../github") as Record<string, unknown>)["disconnectRepository"])],
  ...
  "getOrgIntegration": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../github").getOrgIntegration>("github:getOrgIntegration"), () => (require("../github") as Record<string, unknown>)["getOrgIntegration"])],
  ...
  "getRefreshInstallationsForCallback": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "internal", typeof import("../github").getRefreshInstallationsForCallback>("github:getRefreshInstallationsForCallback"), () => (require("../github") as Record<string, unknown>)["getRefreshInstallationsForCallback"])],
  "markInstallationStale": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "internal", typeof import("../github").markInstallationStale>("github:markInstallationStale"), () => (require("../github") as Record<string, unknown>)["markInstallationStale"])],
  "processWebhookEvent": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "internal", typeof import("../github").processWebhookEvent>("github:processWebhookEvent"), () => (require("../github") as Record<string, unknown>)["processWebhookEvent"])],
  ...
  "startOrgConnection": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../github").startOrgConnection>("github:startOrgConnection"), () => (require("../github") as Record<string, unknown>)["startOrgConnection"])],
  "startOrgInstallationRefresh": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../github").startOrgInstallationRefresh>("github:startOrgInstallationRefresh"), () => (require("../github") as Record<string, unknown>)["startOrgInstallationRefresh"])],
