...
const procedureRegistry = {
  "connectRepository": ["action", typedProcedureResolver(createGeneratedFunctionReference<"action", "public", typeof import("../githubExternal").connectRepository>("githubExternal:connectRepository"), () => (require("../githubExternal") as Record<string, unknown>)["connectRepository"])],
  "listInstallationRepositoriesForProject": ["action", typedProcedureResolver(createGeneratedFunctionReference<"action", "public", typeof import("../githubExternal").listInstallationRepositoriesForProject>("githubExternal:listInstallationRepositoriesForProject"), () => (require("../githubExternal") as Record<string, unknown>)["listInstallationRepositoriesForProject"])],
} as const;
