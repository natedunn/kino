...
const procedureRegistry = {
  "create": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../feedbackBoard").create>("feedbackBoard:create"), () => (require("../feedbackBoard") as Record<string, unknown>)["create"])],
  "get": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../feedbackBoard").get>("feedbackBoard:get"), () => (require("../feedbackBoard") as Record<string, unknown>)["get"])],
  "listProjectBoards": ["query", typedProcedureResolver(createGeneratedFunctionReference<"query", "public", typeof import("../feedbackBoard").listProjectBoards>("feedbackBoard:listProjectBoards"), () => (require("../feedbackBoard") as Record<string, unknown>)["listProjectBoards"])],
  "remove": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../feedbackBoard").remove>("feedbackBoard:remove"), () => (require("../feedbackBoard") as Record<string, unknown>)["remove"])],
  "update": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "public", typeof import("../feedbackBoard").update>("feedbackBoard:update"), () => (require("../feedbackBoard") as Record<string, unknown>)["update"])],
} as const;
