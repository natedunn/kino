	...
	toggle: [
		...
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'mutation',
				'public',
				typeof import('../feedbackCommentEmote').toggle
			>('feedbackCommentEmote:toggle'),
			() => (require('../feedbackCommentEmote') as Record<string, unknown>)['toggle']
		),
	],
} as const;
...
export function createFeedbackCommentEmoteCaller<TCtx extends ProcedureCallerContext>(
	ctx: TCtx
): GeneratedProcedureCaller<TCtx> {
	return generatedRuntime.getCallerFactory()(ctx as any) as GeneratedProcedureCaller<TCtx>;
}

export function createFeedbackCommentEmoteHandler<TCtx extends ProcedureHandlerContext>(
	ctx: TCtx
