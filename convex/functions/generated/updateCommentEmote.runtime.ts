	...
	toggle: [
		...
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'mutation',
				'public',
				typeof import('../updateCommentEmote').toggle
			>('updateCommentEmote:toggle'),
			() => (require('../updateCommentEmote') as Record<string, unknown>)['toggle']
		),
	],
} as const;
...
export function createUpdateCommentEmoteCaller<TCtx extends ProcedureCallerContext>(
	ctx: TCtx
): GeneratedProcedureCaller<TCtx> {
	return generatedRuntime.getCallerFactory()(ctx as any) as GeneratedProcedureCaller<TCtx>;
}

export function createUpdateCommentEmoteHandler<TCtx extends ProcedureHandlerContext>(
	ctx: TCtx
