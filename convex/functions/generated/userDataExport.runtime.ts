	...
	exportData: [
		...
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'query',
				'public',
				typeof import('../userDataExport').exportData
			>('userDataExport:exportData'),
			() => (require('../userDataExport') as Record<string, unknown>)['exportData']
		),
	],
	getAvailableSections: [
		...
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'query',
				'public',
				typeof import('../userDataExport').getAvailableSections
			>('userDataExport:getAvailableSections'),
			() => (require('../userDataExport') as Record<string, unknown>)['getAvailableSections']
		),
	],
} as const;
