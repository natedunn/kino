	...
	create: [
		...
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'mutation',
				'public',
				typeof import('../feedbackComment').create
			>('feedbackComment:create'),
			() => (require('../feedbackComment') as Record<string, unknown>)['create']
		),
	],
	listByFeedback: [
		'query',
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'query',
				'public',
				typeof import('../feedbackComment').listByFeedback
			>('feedbackComment:listByFeedback'),
			() => (require('../feedbackComment') as Record<string, unknown>)['listByFeedback']
		),
	],
	remove: [
		'mutation',
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'mutation',
				'public',
				typeof import('../feedbackComment').remove
			>('feedbackComment:remove'),
			() => (require('../feedbackComment') as Record<string, unknown>)['remove']
		),
	],
	update: [
		'mutation',
		typedProcedureResolver(
			createGeneratedFunctionReference<
				'mutation',
				'public',
				typeof import('../feedbackComment').update
			>('feedbackComment:update'),
			() => (require('../feedbackComment') as Record<string, unknown>)['update']
		),
	],
} as const;
